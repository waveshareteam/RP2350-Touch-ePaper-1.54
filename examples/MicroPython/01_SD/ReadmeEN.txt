...
3. Basic use:
    ...
    2): Copy the WAVESHARE-RP2350-20250807-v1.26.0-16MB.uf2 file in the python directory to the recognized 
        removable disk
    ...
    5): Copy this file to python in the Thonny IDE into RP2350-LCD-0.85 and open the boot.py file
